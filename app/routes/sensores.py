...
from swagger_conf import sc_conectar, sc_desconectar
from swagger_conf import sc_activarMotorCO2, sc_desactivarMotorCO2, sc_activarServoCO2, sc_desactivarServoCO2, sc_configurarExtractor, sc_configurarVentana
from swagger_conf import sc_activarCalefaccion, sc_desactivarCalefaccion, sc_activarAire, sc_desactivarAire, sc_configurarCalefaccion, sc_configurarAire
from swagger_conf import sc_manual, sc_automatica, sc_encender, sc_apagar, sc_configurarLuz

#-------------------------------------------------------------
#                   ALARMA
#-------------------------------------------------------------
@app.route('/inicio/sensorAlarma/conectar', methods=['POST'])
@swag_from(sc_conectar)
def conectar():
...
@swag_from(sc_desactivarMotorCO2)
...
@swag_from(sc_desactivarServoCO2)
...
@swag_from(sc_configurarExtractor)
...
@swag_from(sc_configurarVentana)
...
@swag_from(sc_activarCalefaccion)
...
@swag_from(sc_desactivarCalefaccion)
...
@swag_from(sc_configurarCalefaccion)
