...
from swagger_conf import sc_sensorTemHum, sc_sensorAlarma, sc_sensorLuzAutomatica, sc_sensorCO2
from swagger_conf import sc_nuevoDispositivo, sc_nuevoTemHum, sc_nuevoAlarma, sc_nuevoLuzAutomatica, sc_nuevoCO2
from swagger_conf import sc_borrarDispositivo, sc_borrarTemHum, sc_borrarAlarma, sc_borrarLuzAutomatica, sc_borrarCO2
from swagger_conf import sc_perfil, sc_cambiar, sc_guardarDatos

@app.route('/inicio/sensorTemHum', methods=['GET', 'POST'])
@swag_from(sc_sensorTemHum)
def sensorTemHum():
...
@swag_from(sc_sensorLuzAutomatica)
...
@swag_from(sc_nuevoLuzAutomatica)
...
@swag_from(sc_borrarDispositivo)
...
@swag_from(sc_borrarLuzAutomatica)
